...
public class DeclarationNode extends TypedNode {
	public enum Kind {
		VARIABLE, CONSTANT, ENUMERATED_SET, ENUMERATED_SET_ELEMENT, DEFERRED_SET, FREETYPE, FREETYPE_ELEMENT, OP_OUTPUT_PARAMETER, OP_INPUT_PARAMETER, SUBSTITUION_IDENTIFIER
	}
